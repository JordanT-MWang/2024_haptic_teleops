...
: ${AMENT_CURRENT_PREFIX:="/home/jordan/ros2_teleops/src/install/publisher_speed_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/publisher_speed_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/publisher_speed_test/environment/path.sh"
