...
const int AmpInput1 = 14; //6th top right pin
const int AmpInput2 = 13; //6th top right pin
const int AmpInput3 = 12; //6th top right pin
...
void setup() {
  ...
  BaseEnc.setCount(138500/2);
  ShoulderEnc.setCount(-118550/2);
  ElbowEnc.setCount(84000/2); 
  ...
  delay(100);
  pinMode(AmpInput2, OUTPUT);
  delay(100);
  pinMode(AmpInput3, OUTPUT);
  delay(100);
  //sets all the outputs so robot isnt moving
  analogWrite(AmpInput1, 120);
  analogWrite(AmpInput2, 120);
  analogWrite(AmpInput3, 120);
...
void loop() {
  ...
  EncoderValProcess.toCharArray(EncoderValOutput, 25);
